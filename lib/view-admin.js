...
function editor(db,a={},action='/admin/articles/new',title='خبر جدید'){
 ...
 <label>عنوان<input name="title" value="${e(a.title||'')}" required></label><div class="en-fields"><h3>English version</h3><label>English title<input name="titleEn" dir="ltr" value="${e(a.titleEn||'')}"></label></div>
 ...
 <label>لید خبر<textarea name="lead" placeholder="خلاصه کوتاه و جذاب خبر">${e(a.lead||'')}</textarea></label><div class="en-fields"><label>English lead<textarea name="leadEn" dir="ltr" placeholder="Short English summary">${e(a.leadEn||'')}</textarea></label></div>
 ...
 </div><div class="en-fields"><label>English article body<textarea name="bodyEn" dir="ltr" class="big" placeholder="English version of the article">${e(a.bodyEn||'')}</textarea></label></div>
