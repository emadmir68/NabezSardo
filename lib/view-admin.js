...
function admin(db,backups=[],params=new URLSearchParams(),integrations={},traffic={}){
 ...
 <div class="admin-dashboard-shell"><aside class="admin-sidebar"><div class="admin-sidebar-head"><span class="eyebrow">NEWSROOM</span><b>مدیریت تحریریه</b><small>نبض ساردو</small></div><nav class="admin-sidebar-nav"><a href="#overview"><span>نمای کلی</span></a><a href="#news"><span>مدیریت خبرها</span><i>${a.length}</i></a><a href="#followups"><span>پیگیری تا نتیجه</span><i>${followups.length}</i></a><a href="#live"><span>نبض فوری</span></a><a href="#ads"><span>تبلیغات</span></a><a href="#social"><span>شبکه‌های اجتماعی</span></a><a href="#citizens"><span>خبرهای مردمی</span><i>${db.citizens.length}</i></a><a href="#messages"><span>پیام‌ها</span><i>${db.contacts.length}</i></a><a href="#backup"><span>پشتیبان‌گیری</span></a></nav><a class="admin-sidebar-site" href="/">مشاهده سایت</a></aside><div class="admin-dashboard-content"><div class="admin-welcome"><div><span class="eyebrow">NEWSROOM ADMIN</span><h1>داشبورد تحریریه</h1><p>هر بخش جدا و مستقل است؛ برای مدیریت سریع‌تر از منوی کناری وارد همان قسمت شو.</p></div><a class="btn primary" href="/admin/articles/new">+ خبر جدید</a></div>
...
module.exports={login,admin,editor,followupEditor};