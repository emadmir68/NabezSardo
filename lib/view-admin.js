...
function admin(db,backups=[],params=new URLSearchParams(),integrations={},traffic={}){
 ...
 <section id="overview" class="admin-section-block admin-overview"><div class="admin-section-title"><div><span class="admin-section-no">01</span><div><h2>نمای کلی</h2><p>خلاصه وضعیت تحریریه و آمار سایت</p></div></div></div><details class="admin-fold analytics-fold"><summary><span><b>آمار و عملکرد سایت</b><small>نمودارها، منابع ورودی و صفحات پربازدید</small></span><strong>مشاهده گزارش کامل</strong></summary><div class="admin-fold-body">${analyticsPanel(db,a,traffic)}</div></details>
