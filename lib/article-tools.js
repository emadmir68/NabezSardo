...
function articlePayload(db,f,files,current={},uniqueSlug){
...
module.exports={saveImage,deleteUpload,sanitizeRich,plainFromRich,parseGallery,parseTehranDate,articlePayload,dispatchAndPersist,schedulerTick,socialStatus:social.status};