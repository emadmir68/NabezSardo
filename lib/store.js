...
const initial={
  settings:{siteName:'نبض ساردو',tagline:'صدای ساردوئیه، روایت مردم',siteTemplate:'classic',breakingText:'مهم‌ترین رویدادهای ساردوئیه و جنوب کرمان؛ سریع، دقیق و محلی.',breakingTextEn:'Top local developments from Sardouiyeh and South Kerman — fast, accurate and local.',adEnabled:true,adTitle:'جای تبلیغات شما اینجاست',adTitleEn:'Your ad could be here',adText:'برای رزرو این جایگاه با نبض ساردو در ارتباط باشید',adTextEn:'Contact Nabez Sardo to reserve this placement',adLink:'/contact',adImage:''},
  categories:[
...
function load(){
  ...
  try{
    ...
    if(!['classic','modern'].includes(db.settings.siteTemplate))db.settings.siteTemplate=initial.settings.siteTemplate;
