...
function home(db){
 ...
 <section class="ns-ask" data-ns-ask aria-labelledby="ns-ask-title">
   <div class="wrap">
     <div class="ns-ask-shell">
       <div class="ns-ask-orb" aria-hidden="true"><span></span><i></i><b></b></div>
       <div class="ns-ask-head">
         <div>
           <span class="ns-ask-kicker">NABEZ INTELLIGENCE / NEWS ARCHIVE</span>
           <h2 id="ns-ask-title"><span class="lang-fa">از نبض بپرس</span><span class="lang-en">Ask Nabez</span></h2>
           <p><span class="lang-fa">سؤالت را درباره خبرهای ساردوئیه، جیرفت و جنوب کرمان بپرس؛ پاسخ از آرشیو واقعی نبض ساردو ساخته می‌شود.</span><span class="lang-en">Ask about local news; answers are built from the Nabez Sardo archive.</span></p>
         </div>
         <span class="ns-ask-live"><i></i><span class="lang-fa">آرشیو هوشمند فعال</span><span class="lang-en">Smart archive online</span></span>
       </div>
       <form class="ns-ask-form" data-ns-ask-form>
         <label class="sr-only" for="ns-ask-input">سؤال از نبض ساردو</label>
         <div class="ns-ask-input-wrap">
           <span class="ns-ask-input-icon" aria-hidden="true">⌕</span>
           <input id="ns-ask-input" data-ns-ask-input type="search" inputmode="search" maxlength="180" autocomplete="off" placeholder="مثلاً: امروز در جیرفت چه خبر مهمی منتشر شده؟">
           <button type="submit" data-ns-ask-submit><span class="lang-fa">بپرس</span><span class="lang-en">Ask</span><span class="ns-ask-arrow" aria-hidden="true">←</span></button>
         </div>
       </form>
       <div class="ns-ask-examples" aria-label="سؤال‌های پیشنهادی">
         <button type="button" data-ns-ask-example="امروز در جیرفت چه خبر مهمی منتشر شده؟">امروز در جیرفت چه خبر است؟</button>
         <button type="button" data-ns-ask-example="آخرین خبرهای مربوط به راهداری چیست؟">آخرین خبرهای راهداری</button>
         <button type="button" data-ns-ask-example="درباره ساردوئیه چه خبرهایی منتشر شده؟">خبرهای ساردوئیه</button>
       </div>
       <div class="ns-ask-status" data-ns-ask-status aria-live="polite"></div>
       <div class="ns-ask-result" data-ns-ask-result hidden>
         <div class="ns-ask-answer-row">
           <span class="ns-ask-answer-mark" aria-hidden="true">N</span>
           <div><small>پاسخ نبض</small><p data-ns-ask-answer></p></div>
         </div>
         <div class="ns-ask-sources-wrap" data-ns-ask-sources-wrap hidden>
           <div class="ns-ask-sources-title"><b>منابع این پاسخ</b><span>خبرهای منتشرشده در نبض ساردو</span></div>
           <div class="ns-ask-sources" data-ns-ask-sources></div>
         </div>
       </div>
       <div class="ns-ask-foot"><span>پاسخ‌ها فقط بر اساس خبرهای منتشرشده در نبض ساردو ساخته می‌شوند.</span><span class="ns-ask-foot-dot">◆</span><span>برای جزئیات، منبع خبر را باز کنید.</span></div>
     </div>
   </div>
 </section>
