...
function siteSchema(){
  return [
    ...
    {'@context':'https://schema.org','@type':'NewsMediaOrganization',name:'نبض ساردو',alternateName:'Nabez Sardo',url:PUBLIC_BASE+'/',description:'رسانه محلی ساردو، ساردوئیه، جیرفت، عنبرآباد، کهنوج و جنوب کرمان',areaServed:[{'@type':'Place',name:'ساردوئیه'},{'@type':'Place',name:'جیرفت'},{'@type':'Place',name:'عنبرآباد'},{'@type':'Place',name:'کهنوج'},{'@type':'Place',name:'جنوب کرمان'}]}
  ];
}
