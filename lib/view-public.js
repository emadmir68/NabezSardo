   ...
   <div class="hero-short-story-viewport">
     ${shortNews.map((a,i)=>{
       ...
       return `<a class="hero-short-story ${i===0?'is-active':''}" data-short-story data-expires="${expiresAt}" href="${url}" aria-hidden="${i===0?'false':'true'}">
         <span class="hero-short-story-text"><span class="lang-fa">${e(a.title)}</span><span class="lang-en">${e(a.titleEn||a.title)}</span></span>
         <small><span class="lang-fa">مشاهده ←</span><span class="lang-en">Open →</span></small>
       </a>`;
     }).join('')}
   </div>
