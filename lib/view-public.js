...
function home(db){
 ...
 <a class="home-dashboard-entry" href="/admin/login" aria-label="ورود به داشبورد مدیریت">
   <span class="home-dashboard-entry__icon" aria-hidden="true">⌘</span>
   <span class="lang-fa">ورود به داشبورد</span>
   <span class="lang-en">Dashboard Login</span>
 </a>
