...
function home(db){
 ...
 <main><section class="ns-hero-clean">
  <div class="ns-hero-clean__media">
    <img src="/hero-mosque.jpg?v=hero-clean-v1" alt="مسجد ساردوئیه" fetchpriority="high" decoding="async">
    <div class="ns-hero-clean__media-fade"></div>
    <span class="ns-hero-clean__badge"><span class="lang-fa">نبض ساردوئیه</span><span class="lang-en">NABEZ SARDOUIYEH</span></span>
  </div>
  <div class="wrap ns-hero-clean__body">
    <div class="ns-hero-clean__copy">
      <h1><span class="lang-fa">نبضِ ساردوئیه؛ خبر محلی، روشن و نزدیک</span><span class="lang-en">Nabez Sardouiyeh — Local news, clear and close</span></h1>
      ...
      <div class="ns-hero-clean__actions">
        <a class="btn gold" href="#latest"><span class="lang-fa">تازه‌ترین خبرها</span><span class="lang-en">Latest News</span></a>
        <a class="textlink" href="/about"><span class="lang-fa">درباره تحریریه</span><span class="lang-en">About the Newsroom</span></a>
      </div>
    </div>
    <div class="ns-hero-clean__pulse" aria-hidden="true">
      <svg viewBox="0 0 420 120" focusable="false">
        <path d="M18 66H114L141 43L166 88L205 18L242 91L274 47L304 66H402" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
