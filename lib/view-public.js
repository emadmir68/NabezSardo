...
function article(db,a){
  ...
  <main class="wrap article article-premium" data-cat-tone="${tone}">
    ...
    <article class="article-shell" data-article-root data-article-title="${e(a.title)}" data-article-url="${e(shareUrl)}" data-article-canonical="${e(articleUrl)}" data-article-image="${e(previewImage)}" data-article-image-kind="${e(!a.image?'none':/auto-cover/i.test(String(a.image))?'auto':'real')}" data-article-lead="${e(shareLead)}">
