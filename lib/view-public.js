...
function home(db){
 ...
 const shortNewsMarkup=shortNews.map((a,i)=>{
   ...
   const label=a.location||'خبر کوتاه';
   return `<article class="home-short-news-row" data-short-tone="${i%4}">
     <span class="home-short-news-index" aria-hidden="true">${String(i+1).padStart(2,'0')}</span>
     <div class="home-short-news-copy">
       <div class="home-short-news-kicker"><span class="home-short-news-label">${e(label)}</span><span class="home-short-news-mini">• ${Number(a.views||0).toLocaleString('fa-IR')}</span></div>
       <h3><a href="${url}"><span class="lang-fa">${e(a.title)}</span><span class="lang-en">${e(a.titleEn||a.title)}</span></a></h3>
       ${lead?`<p><span class="lang-fa">${e(lead)}</span><span class="lang-en">${e(compactText(a.leadEn||lead,125))}</span></p>`:''}
       <div class="home-short-news-meta">
         <div class="home-short-news-time"><span class="home-short-news-dot" aria-hidden="true"></span><time class="news-date" data-news-date="${e(date)}"></time></div>
         <a class="home-short-news-open" href="${url}"><span class="lang-fa">مشاهده خبر ←</span><span class="lang-en">Read story →</span></a>
       </div>
     </div>
   </article>`;
 }).join('');
   ...
   <div class="home-short-news-shell">
     <div class="home-short-news-head">
       <div>
         ...
         <p><span class="lang-fa">تازه‌ترین خبرها؛ کوتاه، سریع و بدون حاشیه.</span><span class="lang-en">Latest updates — short, fast and to the point.</span></p>
       </div>
       <a class="more" href="/category/short-news"><span class="lang-fa">همه خبرهای کوتاه</span><span class="lang-en">All short news</span></a>
     </div>
