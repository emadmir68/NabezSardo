...
function home(db){
 ...
 ${todayPulse.length?`<section class="wrap today-pulse-section now-pulse-section" aria-label="نبض الآن">
   <div class="today-pulse-shell now-pulse-shell">
     <div class="today-pulse-intro">
       <span class="today-pulse-kicker"><i aria-hidden="true"></i><span class="lang-fa">NABEZ NOW / LIVE</span><span class="lang-en">NABEZ NOW / LIVE</span></span>
       <h2><span class="lang-fa">نبض الآن</span><span class="lang-en">Nabez Now</span></h2>
       <p><span class="lang-fa">پنج اتفاق تازه‌ای که همین الآن در نبض ساردو باید در جریانشان باشید.</span><span class="lang-en">Five fresh developments to keep on your radar right now.</span></p>
       <div class="today-pulse-clock"><span class="today-pulse-clock-dot" aria-hidden="true"></span><span class="lang-fa">در حال به‌روزرسانی</span><span class="lang-en">Updating live</span><b data-live-clock></b></div>
       <a class="now-pulse-all" href="/all-news"><span class="lang-fa">مشاهده همه خبرها ←</span><span class="lang-en">View all news →</span></a>
