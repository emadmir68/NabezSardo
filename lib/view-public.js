...
function home(db){
 ...
 <section class="wrap home-ad-slot" aria-label="جایگاه تبلیغات">
   <a class="home-ad-card" href="/contact">
     <div class="home-ad-copy">
       ...
       <strong><span class="lang-fa">جای تبلیغات شما اینجاست</span><span class="lang-en">Your ad could be here</span></strong>
       <small><span class="lang-fa">برای رزرو این جایگاه با نبض ساردو در ارتباط باشید</span><span class="lang-en">Contact Nabez Sardo to reserve this placement</span></small>
     </div>
     <div class="home-ad-visual" aria-hidden="true">
       <div class="home-ad-orbit orbit-one"></div>
       <div class="home-ad-orbit orbit-two"></div>
       <div class="home-ad-device">
         <svg viewBox="0 0 280 160" role="presentation">
           <defs>
             <linearGradient id="adGlow" x1="0" x2="1">
               <stop offset="0" stop-color="#7d1839"/>
               <stop offset=".5" stop-color="#d2a85e"/>
               <stop offset="1" stop-color="#7d1839"/>
             </linearGradient>
           </defs>
     ...
     <span class="home-ad-cta"><span class="lang-fa">رزرو جایگاه ←</span><span class="lang-en">Reserve spot →</span></span>
   </a>
 </section>
