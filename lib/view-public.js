...
function home(db){
 ...
 const immersiveStories=[leadStory,...highlightNews].filter(Boolean).slice(0,3);
 const immersiveMarkup=`<section class="ns-immersive" data-immersive-scene aria-label="ساردوئیه همین حالا">
   <div class="ns-immersive__sticky">
     <div class="ns-immersive__sky" aria-hidden="true"></div>
     <div class="ns-immersive__sun" aria-hidden="true"></div>
     <div class="ns-immersive__mist ns-immersive__mist--a" aria-hidden="true"></div>
     <div class="ns-immersive__mist ns-immersive__mist--b" aria-hidden="true"></div>
     <svg class="ns-immersive__topo" viewBox="0 0 1600 900" preserveAspectRatio="none" aria-hidden="true">
       <g fill="none" stroke="currentColor" stroke-width="1.25" opacity=".42">
         <path d="M-80 690C180 560 330 610 560 520s390-170 650-80 370 140 520 75"/>
         <path d="M-60 730c220-135 420-80 615-170 250-115 380-110 620-45 220 60 350 50 510-5"/>
         <path d="M-10 770c250-140 430-110 640-170 250-70 360-90 590-25 210 60 340 55 500 10"/>
         <path d="M70 810c220-90 380-95 590-130 270-45 390-65 620 5 170 52 290 55 390 28"/>
         <path d="M170 850c210-65 390-58 570-80 260-32 410-20 600 45 100 34 205 47 300 40"/>
       </g>
     </svg>
     <svg class="ns-immersive__mountains ns-immersive__mountains--far" viewBox="0 0 1600 900" preserveAspectRatio="none" aria-hidden="true"><path d="M0 690 170 560 310 615 470 480 620 610 780 455 930 590 1090 430 1260 575 1435 500 1600 610V900H0Z"/></svg>
     <svg class="ns-immersive__mountains ns-immersive__mountains--mid" viewBox="0 0 1600 900" preserveAspectRatio="none" aria-hidden="true"><path d="M0 745 210 610 390 690 590 550 780 700 980 565 1180 690 1400 590 1600 710V900H0Z"/></svg>
     <svg class="ns-immersive__mountains ns-immersive__mountains--near" viewBox="0 0 1600 900" preserveAspectRatio="none" aria-hidden="true"><path d="M0 805 240 700 420 775 650 655 850 790 1090 675 1320 785 1490 710 1600 760V900H0Z"/></svg>
     <div class="ns-immersive__pulse" aria-hidden="true"><svg viewBox="0 0 980 120"><path d="M0 65h235l30-22 28 48 42-78 48 83 40-59 44 28h513"/></svg></div>
     <div class="wrap ns-immersive__content">
       <div class="ns-immersive__intro">
         <span class="eyebrow">IMMERSIVE / NABEZ SARDO</span>
         <h2><span class="lang-fa">ساردوئیه، همین حالا</span><span class="lang-en">Sardouiyeh, right now</span></h2>
         <p><span class="lang-fa">سه خبر مهم امروز، در یک نمای زنده از منطقه. با اسکرول، لایه‌ها حرکت می‌کنند و خبرها از دل صحنه ظاهر می‌شوند.</span><span class="lang-en">Three important stories, revealed through a living regional scene as you scroll.</span></p>
       </div>
       <div class="ns-immersive__stories">
         ${immersiveStories.map((a,i)=>{const c=categoryOf(a),url=storyUrl(a),img=a.image||'/assets/placeholder.svg';return `<a class="ns-immersive__story ns-immersive__story--${i+1}" data-immersive-story href="${url}" data-cat-tone="${e(categoryTone(c))}"><span class="ns-immersive__story-index">0${i+1}</span><div class="ns-immersive__story-media"><img src="${e(img)}" alt="${e(a.title)}" loading="lazy" decoding="async"></div><div class="ns-immersive__story-copy"><small>${e(c?.name||'خبر')}</small><h3><span class="lang-fa">${e(a.title)}</span><span class="lang-en">${e(a.titleEn||a.title)}</span></h3><span class="ns-immersive__story-open"><span class="lang-fa">مشاهده خبر ←</span><span class="lang-en">Read story →</span></span></div></a>`}).join('')}
       </div>
       <div class="ns-immersive__hint"><span></span><small><span class="lang-fa">برای حرکت در صحنه اسکرول کنید</span><span class="lang-en">Scroll to move through the scene</span></small></div>
     </div>
   </div>
 </section>`;
