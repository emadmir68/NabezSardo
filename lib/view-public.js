...
function home(db){
 ...
 <main><section class="hero"><div class="hero-bg"></div><div class="wrap hero-grid"><div class="hero-copy reveal"><span class="chip">3D EDITORIAL · SARDOUIYEH</span><h1>نبضِ ساردوئیه،<br>با یک هویت رسانه‌ای تازه</h1><p>خبر محلی، گزارش میدانی، روایت تصویری و صدای مردم؛ در یک تجربه خبری مدرن و متفاوت.</p><div class="actions"><a class="btn gold" href="#latest">تازه‌ترین خبرها</a><a class="textlink" href="/about">درباره تحریریه</a></div></div><div class="hero-art reveal"><div class="orbit o1"></div><div class="orbit o2"></div><div class="hero-emblem tilt" aria-hidden="true"><div class="emblem-glow"></div><svg viewBox="0 0 320 320" focusable="false"><defs><linearGradient id="heroGold" x1="52" y1="42" x2="255" y2="275" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#f7dfaa"/><stop offset=".48" stop-color="#d3a55a"/><stop offset="1" stop-color="#85551f"/></linearGradient><linearGradient id="heroWine" x1="84" y1="134" x2="254" y2="252" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#b33a62"/><stop offset=".58" stop-color="#751a3a"/><stop offset="1" stop-color="#3d0b20"/></linearGradient><radialGradient id="heroSun" cx=".5" cy=".5" r=".5"><stop offset="0" stop-color="#fff4d1"/><stop offset=".52" stop-color="#e8c173"/><stop offset="1" stop-color="#9c6828" stop-opacity=".05"/></radialGradient></defs><circle cx="160" cy="160" r="112" fill="none" stroke="url(#heroGold)" stroke-width="1.4" opacity=".42"/><circle cx="160" cy="160" r="91" fill="none" stroke="#d9b567" stroke-width=".8" opacity=".18"/><circle cx="220" cy="102" r="34" fill="url(#heroSun)"/><path d="M54 220 111 151l33 37 39-58 83 90H54Z" fill="url(#heroWine)" opacity=".94"/><path d="m54 220 57-69 33 37 39-58 83 90" fill="none" stroke="url(#heroGold)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/><path d="M73 233c48-19 113-19 174 0" fill="none" stroke="#eed08b" stroke-width="2.4" stroke-linecap="round" opacity=".78"/><path d="M96 247c38-11 89-11 128 0" fill="none" stroke="#9d3153" stroke-width="2" stroke-linecap="round" opacity=".7"/><circle cx="93" cy="91" r="3.2" fill="#f0cf86"/><circle cx="116" cy="74" r="1.8" fill="#f0cf86" opacity=".72"/><circle cx="77" cy="119" r="1.7" fill="#f0cf86" opacity=".55"/></svg></div></div></div></section>
