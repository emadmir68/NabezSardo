...
function article(db,a){
  ...
  <main class="wrap article article-premium" data-cat-tone="${tone}">
    ...
    <article class="article-shell" data-article-root data-article-title="${e(a.title)}" data-article-url="${e(shareUrl)}" data-article-canonical="${e(articleUrl)}" data-article-image="${e(a.image||'')}" data-article-lead="${e(shareLead)}">
      ...
      <section class="article-tv-card" data-article-tv>
        <div class="article-tv-card-copy">
          <span class="article-tv-kicker">NABEZ TV · PREVIEW</span>
          <h3><span class="lang-fa">این خبر را به سبک نبض TV ببین</span><span class="lang-en">Watch this story in Nabez TV style</span></h3>
          <p><span class="lang-fa">نسخه آزمایشی عمودی 9:16 با عکس، تیتر و خلاصه همین خبر؛ بدون تصویرسازی هوش مصنوعی.</span><span class="lang-en">A 9:16 preview using this story's own image, headline and summary.</span></p>
        </div>
        <button class="article-tv-play" type="button" data-tv-open>
          <span class="article-tv-play-icon" aria-hidden="true">▶</span>
          <span><b class="lang-fa">تماشای نبض TV</b><b class="lang-en">Watch Nabez TV</b><small>15s / 30s</small></span>
        </button>

        <div class="article-tv-modal" data-tv-modal hidden aria-hidden="true">
          <button class="article-tv-backdrop" type="button" data-tv-close aria-label="بستن"></button>
          <div class="article-tv-sheet" role="dialog" aria-modal="true" aria-label="پیش‌نمایش نبض TV">
            <div class="article-tv-sheet-head">
              <div><span>NABEZ TV</span><b><span class="lang-fa">پیش‌نمایش ویدیوی خبر</span><span class="lang-en">Story video preview</span></b></div>
              <div class="article-tv-sheet-tools">
                <div class="article-tv-duration" data-tv-duration-switch>
                  <button class="active" type="button" data-tv-duration="15">15s</button>
                  <button type="button" data-tv-duration="30">30s</button>
                </div>
                <button class="article-tv-close" type="button" data-tv-close aria-label="بستن">×</button>
              </div>
            </div>

            <div class="article-tv-public-device">
              <div class="tv-frame article-tv-frame" data-tv-frame data-duration="15" style="--tv-total:15s">
                <div class="tv-progress"><i></i></div>
                <div class="tv-scene tv-scene-intro">
                  <div class="tv-brand-pulse"><i></i><b>نبض ساردو</b></div>
                  <strong>NABEZ TV</strong>
                  <small>خبر در حرکت</small>
                </div>
                <div class="tv-scene tv-scene-story">
                  <div class="tv-media">
                    ${a.image?`<div class="tv-media-bg" style="background-image:url(&quot;${e(a.image)}&quot;)"></div><img class="tv-media-img" src="${e(a.image)}" alt="">`:`<div class="tv-media-empty"><span>نبض ساردو</span><small>کاور آماده موضوعی خبر</small></div>`}
                  </div>
                  <div class="tv-story-shade"></div>
                  <div class="tv-story-copy">
                    <span>${e(c?.name||'خبر')}</span>
                    <h2>${e(a.title)}</h2>
                    <small>نبض ساردو · رسانه محلی جنوب کرمان</small>
                  </div>
                </div>
                <div class="tv-scene tv-scene-summary">
                  <span>خلاصه خبر</span>
                  <h3>${e(a.title)}</h3>
                  <p>${e(compactText(a.lead||a.body||a.title,260))}</p>
                </div>
                <div class="tv-scene tv-scene-outro">
                  <div class="tv-outro-mark">N</div>
                  <b>ادامه خبر در نبض ساردو</b>
                  <strong>nabzesardo.ir</strong>
                  <small>ساردوئیه · جیرفت · جنوب کرمان</small>
                </div>
                <div class="tv-safe-top"><span>نبض TV</span><b data-tv-seconds>15s</b></div>
              </div>
            </div>

            <div class="article-tv-demo-note">
              <span class="lang-fa">نسخه نمایشی است؛ هنوز فایل MP4 واقعی ساخته نمی‌شود.</span>
              <span class="lang-en">Preview only; no MP4 is generated yet.</span>
            </div>
          </div>
        </div>
      </section>
...
module.exports={home,archive,briefs,article,category,simple,search,localHub,nabez60};